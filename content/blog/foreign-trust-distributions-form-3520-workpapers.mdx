---
title: "Foreign Trust Distributions: Form 3520 Workpapers"
description: "A records-first guide to foreign trust distributions: form 3520 workpapers, including the questions to classify, documents to gather, related U.S. forms, and when a written scope helps."
date: "2026-08-05"
dateModified: "2026-08-05"
author: "Chip Moreno"
category: "Form 3520"
tags: ["Form 3520","U.S. expat tax","international tax","Foreign","Trust","Distributions"]
...
faqs:
  - question: "What is the first step for foreign trust distributions: form 3520 workpapers?"
...
A useful final question for “Foreign Trust Distributions: Form 3520 Workpapers” is whether the file would still make sense to a reviewer who did not participate in the original transaction. If not, add the missing timeline, legal document, calculation note, or source citation before closing the work.
...
For Foreign Trust Distributions: Form 3520 Workpapers, the headline rule is only a starting point. The useful conclusion is the one supported by the filing-year facts, source documents, ownership trail, and applicable instructions.
...
Keep the Form 3520 overlay separate from the federal map. Residence, source, domicile, treaty, and local tax payment may affect the result, but one jurisdiction’s terminology does not automatically determine another jurisdiction’s rules.
