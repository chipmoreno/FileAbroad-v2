---
title: "Form 3520-A: Foreign Trust Owner Records"
description: "A records-first guide to form 3520-a: foreign trust owner records, including the questions to classify, documents to gather, related U.S. forms, and when a written scope helps."
date: "2026-08-05"
dateModified: "2026-08-05"
author: "Chip Moreno"
category: "Form 3520-A"
tags: ["Form 3520-A","U.S. expat tax","international tax","Form","3520","Foreign"]
relatedBlogSlugs: ["form-3520-a-foreign-trust-annual","foreign-pension-form-3520"]
relatedGuideSlugs: ["foreign-trusts-guide"]
relatedServiceSlugs: ["expat-tax-filing"]
faqs:
  - question: "What is the first step for form 3520-a: foreign trust owner records?"
...
A useful final question for “Form 3520-A: Foreign Trust Owner Records” is whether the file would still make sense to a reviewer who did not participate in the original transaction. If not, add the missing timeline, legal document, calculation note, or source citation before closing the work.



## When a written scope helps

A written scope is useful when the issue spans multiple years, countries, states, accounts, entities, pensions, trusts, forms, elections, or competing filing theories. FileAbroad’s [consultation path](/consultation) is designed to turn the facts into a written issue list, document request, deliverable, and boundary. For ongoing return preparation, see the [expat tax filing service](/services/expat-tax-filing) and the related [foreign trusts guide](/guides/foreign-trusts-guide).
...
- [IRS Instructions for Form 3520-A](https://www.irs.gov/instructions/i3520a)

- [FileAbroad consultation](/consultation)

- [FileAbroad foreign trusts guide](/guides/foreign-trusts-guide)

For Form 3520-A: Foreign Trust Owner Records, the headline rule is only a starting point. The useful conclusion is the one supported by the filing-year facts, source documents, ownership trail, and applicable instructions.
...
Keep the Form 3520-A overlay separate from the federal map. Residence, source, domicile, treaty, and local tax payment may affect the result, but one jurisdiction’s terminology does not automatically determine another jurisdiction’s rules.
