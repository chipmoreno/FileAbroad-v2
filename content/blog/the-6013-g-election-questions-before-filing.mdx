---
title: "The 6013(g) Election: Questions Before Filing"
description: "A records-first guide to the 6013(g) election: questions before filing, including the questions to classify, documents to gather, related U.S. forms, and when a written scope helps."
date: "2026-08-05"
dateModified: "2026-08-05"
author: "Chip Moreno"
category: "Foreign spouse"
tags: ["Foreign spouse","U.S. expat tax","international tax","6013","Election","Questions"]
...
faqs:
  - question: "What is the first step for the 6013(g) election: questions before filing?"
...
A useful final question for “The 6013(g) Election: Questions Before Filing” is whether the file would still make sense to a reviewer who did not participate in the original transaction. If not, add the missing timeline, legal document, calculation note, or source citation before closing the work.
...
For The 6013(g) Election: Questions Before Filing, the headline rule is only a starting point. The useful conclusion is the one supported by the filing-year facts, source documents, ownership trail, and applicable instructions.
