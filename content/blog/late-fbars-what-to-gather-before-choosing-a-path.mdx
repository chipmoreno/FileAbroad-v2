---
title: "Late FBARs: What to Gather Before Choosing a Path"
description: "A records-first guide to late fbars: what to gather before choosing a path, including the questions to classify, documents to gather, related U.S. forms, and when a written scope helps."
date: "2026-08-05"
dateModified: "2026-08-05"
author: "Chip Moreno"
category: "Catch-up"
tags: ["Catch-up","U.S. expat tax","international tax","Late","FBARs","What"]
...
faqs:
  - question: "What is the first step for late fbars: what to gather before choosing a path?"
...
A useful final question for “Late FBARs: What to Gather Before Choosing a Path” is whether the file would still make sense to a reviewer who did not participate in the original transaction. If not, add the missing timeline, legal document, calculation note, or source citation before closing the work.
...
For Late FBARs: What to Gather Before Choosing a Path, the headline rule is only a starting point. The useful conclusion is the one supported by the filing-year facts, source documents, ownership trail, and applicable instructions.
