---
title: "Crypto Tax Software for Expats: What It Cannot Decide"
description: "How to use crypto tax software as a reconciliation tool while preserving custody, foreign-account, entity, treaty, and income classification review."
date: "2026-08-03"
author: "Chip Moreno"
category: "Crypto Taxes"
tags: ["crypto tax software", "digital assets", "FBAR", "Form 8938", "expat taxes"]
relatedGuideSlugs:
  - "crypto-taxes-expats"
relatedServiceSlugs:
  - "expat-tax-filing"
faqs:
  - question: "Can crypto software prepare my entire expat return?"
    answer: "Software can help calculate transactions, but it may not classify foreign exchanges, wallets, pensions, entities, treaty positions, FBAR, Form 8938, or foreign tax correctly. Review the output with the full facts."
  - question: "What should I import into the software?"
    answer: "Import complete wallet and exchange histories, then reconcile duplicates, transfers, basis, fees, and missing transactions. Keep the raw exports."
  - question: "Does software know whether an exchange is foreign?"
    answer: "Not reliably. Verify the platform’s legal entity, custody model, and country from its terms and account documents."
---

# Crypto Tax Software for Expats: What It Cannot Decide

Crypto tax software is useful for transaction normalization and gain/loss calculations, but it is not a substitute for expat classification. The software may not know whether a platform is a foreign financial institution, whether a wallet is self-custodied, whether an entity owns the asset, or whether a treaty affects the result.

## Use software as a source ledger

Import raw exports, preserve original files, and reconcile all wallets and exchanges. Remove duplicate transfers only after verifying the destination wallet. Review staking, NFT, DeFi, loan, and reward transactions manually where the software lacks the protocol context.
...
This article is educational and does not endorse a product or certify a return. FileAbroad can review a software output within the [tax filing intake](/intake?service=expat-tax-filing).
