---
title: "When to Refer a Tax Question to an Attorney"
description: "A records-first guide to when to refer a tax question to an attorney, including the questions to classify, documents to gather, related U.S. forms, and when a written scope helps."
date: "2026-08-05"
dateModified: "2026-08-05"
author: "Chip Moreno"
category: "Professional boundaries"
tags: ["Professional boundaries","U.S. expat tax","international tax","When","Refer","Question"]
...
faqs:
  - question: "What is the first step for when to refer a tax question to an attorney?"
...
A useful final question for “When to Refer a Tax Question to an Attorney” is whether the file would still make sense to a reviewer who did not participate in the original transaction. If not, add the missing timeline, legal document, calculation note, or source citation before closing the work.



## When a written scope helps

A written scope is useful when the issue spans multiple years, countries, states, accounts, entities, pensions, trusts, forms, elections, or competing filing theories. FileAbroad’s [consultation path](/consultation) is designed to turn the facts into a written issue list, document request, deliverable, and boundary. For ongoing return preparation, see the [expat tax filing service](/services/expat-tax-filing) and the related [expat tax guide](/guides/expat-tax-guide).
...
- [IRS Tax Professionals guidance](https://www.irs.gov/tax-professionals)

- [FileAbroad consultation](/consultation)

- [FileAbroad expat tax guide](/guides/expat-tax-guide)

For When to Refer a Tax Question to an Attorney, the headline rule is only a starting point. The useful conclusion is the one supported by the filing-year facts, source documents, ownership trail, and applicable instructions.
...
Keep the Professional boundaries overlay separate from the federal map. Residence, source, domicile, treaty, and local tax payment may affect the result, but one jurisdiction’s terminology does not automatically determine another jurisdiction’s rules.
