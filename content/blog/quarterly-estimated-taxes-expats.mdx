---
title: "Quarterly Estimated Taxes for Americans Abroad"
description: "When self-employed expats and investors may need estimated payments, and how FEIE, foreign tax credits, self-employment tax, and prior-year rules interact."
date: "2026-08-03"
author: "Chip Moreno"
category: "Self-Employment Abroad"
tags: ["estimated tax", "quarterly taxes", "expat taxes", "self-employment"]
relatedGuideSlugs:
  - "self-employment-abroad-tax-guide"
relatedServiceSlugs:
  - "expat-tax-filing"
faqs:
  - question: "Do all expats have to make quarterly payments?"
    answer: "No. The requirement depends on expected tax after withholding and credits, prior-year tax, income timing, and the current estimated-tax rules."
  - question: "Do foreign tax credits reduce estimated payments?"
    answer: "They may reduce the projected U.S. balance when the taxes are creditable and the income-source and timing assumptions are supportable."
  - question: "Does FEIE eliminate estimated tax?"
    answer: "It may reduce income tax on qualifying earned income, but it does not automatically eliminate self-employment tax, state tax, or tax on other income."
---

# Quarterly Estimated Taxes for Americans Abroad

An expat without U.S. payroll withholding can still owe federal tax during the year. Self-employment income, investment income, pension distributions, and uneven foreign tax payments make the estimate especially sensitive to timing.

## Build the estimate from the whole return

Project wages, business receipts, expenses, investment income, pensions, FEIE, foreign tax credits, self-employment tax, and withholding. Track the assumptions and update them when income changes. A prior-year safe-harbor calculation may be relevant but should be checked against the current instructions.

## Foreign taxes and timing

A foreign tax paid late or assessed under a different tax year may not reduce the current estimate in the way a taxpayer expects. Preserve the foreign assessment, payment date, currency conversion, and Form 1116 category.
...
This article is educational and does not calculate installments or penalty exposure. FileAbroad can prepare an estimated-tax model within a written filing scope through the [tax filing intake](/intake?service=expat-tax-filing).
