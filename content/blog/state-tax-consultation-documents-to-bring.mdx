---
title: "State Tax Consultation: Documents to Bring"
description: "A records-first guide to state tax consultation: documents to bring, including the questions to classify, documents to gather, related U.S. forms, and when a written scope helps."
date: "2026-08-05"
dateModified: "2026-08-05"
author: "Chip Moreno"
category: "Consultation"
tags: ["Consultation","U.S. expat tax","international tax","State","Documents"]
...
faqs:
  - question: "What is the first step for state tax consultation: documents to bring?"
...
A useful final question for “State Tax Consultation: Documents to Bring” is whether the file would still make sense to a reviewer who did not participate in the original transaction. If not, add the missing timeline, legal document, calculation note, or source citation before closing the work.
...
For State Tax Consultation: Documents to Bring, the headline rule is only a starting point. The useful conclusion is the one supported by the filing-year facts, source documents, ownership trail, and applicable instructions.
