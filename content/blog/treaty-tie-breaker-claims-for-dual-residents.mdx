---
title: "Treaty Tie-Breaker Claims for Dual Residents"
description: "A records-first guide to treaty tie-breaker claims for dual residents, including the questions to classify, documents to gather, related U.S. forms, and when a written scope helps."
date: "2026-08-05"
dateModified: "2026-08-05"
author: "Chip Moreno"
category: "Treaties"
tags: ["Treaties","U.S. expat tax","international tax","Treaty","Breaker","Claims"]
...
faqs:
  - question: "What is the first step for treaty tie-breaker claims for dual residents?"
...
A useful final question for “Treaty Tie-Breaker Claims for Dual Residents” is whether the file would still make sense to a reviewer who did not participate in the original transaction. If not, add the missing timeline, legal document, calculation note, or source citation before closing the work.
...
For Treaty Tie-Breaker Claims for Dual Residents, the headline rule is only a starting point. The useful conclusion is the one supported by the filing-year facts, source documents, ownership trail, and applicable instructions.
