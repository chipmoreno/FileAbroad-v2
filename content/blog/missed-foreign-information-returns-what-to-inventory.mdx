---
title: "Missed Foreign Information Returns: What to Inventory"
description: "A records-first guide to missed foreign information returns: what to inventory, including the questions to classify, documents to gather, related U.S. forms, and when a written scope helps."
date: "2026-08-05"
dateModified: "2026-08-05"
author: "Chip Moreno"
category: "Catch-up"
tags: ["Catch-up","U.S. expat tax","international tax","Missed","Foreign","Information"]
relatedBlogSlugs: ["delinquent-fbar-filing-how-to-catch-up","streamlined-vs-delinquent-fbar-procedures"]
relatedGuideSlugs: ["streamlined-filing-guide"]
relatedServiceSlugs: ["streamlined-filing"]
faqs:
  - question: "What is the first step for missed foreign information returns: what to inventory?"
...
- [FileAbroad streamlined filing guide](/guides/streamlined-filing-guide)

For Missed Foreign Information Returns: What to Inventory, the headline rule is only a starting point. The useful conclusion is the one supported by the filing-year facts, source documents, ownership trail, and applicable instructions.
...
Keep the Catch-up overlay separate from the federal map. Residence, source, domicile, treaty, and local tax payment may affect the result, but one jurisdiction’s terminology does not automatically determine another jurisdiction’s rules.
