---
title: "Tax Deductions for Freelancers Living Abroad"
description: "A recordkeeping framework for business expenses, home office, travel, software, currency conversion, FEIE, and foreign tax credit issues for expat freelancers."
date: "2026-08-03"
author: "Chip Moreno"
category: "Self-Employment Abroad"
tags: ["freelancer taxes", "Schedule C", "business deductions", "FEIE", "expat taxes"]
relatedGuideSlugs:
  - "self-employment-abroad-tax-guide"
relatedServiceSlugs:
  - "expat-tax-filing"
faqs:
  - question: "Can I deduct my foreign rent as a freelancer?"
    answer: "A home-office or rent deduction requires the applicable U.S. business-use rules and records. Living abroad does not make personal housing automatically deductible."
  - question: "Can I deduct travel between countries?"
    answer: "Travel must be analyzed under the business-purpose and substantiation rules. A digital-nomad lifestyle is not automatically business travel."
  - question: "Are software and platform fees deductible?"
    answer: "They may be ordinary and necessary business expenses when connected to the trade or business, but retain invoices, business purpose, and allocation records."
---

# Tax Deductions for Freelancers Living Abroad

Freelancers abroad often mix business and personal travel, home use, devices, software, and banking. The deduction question is not whether the expense happened overseas; it is whether the expense is connected to the U.S. trade or business, properly substantiated, and allocated between business and personal use.

## Build an expense ledger

Track date, vendor, currency, amount, business purpose, client or project, payment method, and receipt. Separate recurring software and platform fees from travel and equipment. Convert each item under a consistent documented method.

## Home office and travel

A home-office deduction has specific exclusivity and regular-use requirements. Foreign rent, utilities, and internet should not be claimed simply because work was performed at home. Travel between countries requires a business-purpose and tax-home analysis; a personal move is not automatically deductible business travel.
...
This article is educational and does not approve a deduction. FileAbroad can review the expense ledger within the [tax filing intake](/intake?service=expat-tax-filing).
