---
title: "Staking Rewards and U.S. Tax for Expats"
description: "How Americans abroad should document staking rewards, fair-market value, basis, foreign exchanges, and the separate income and account reporting questions."
date: "2026-08-03"
author: "Chip Moreno"
category: "Crypto Taxes"
tags: ["staking rewards", "digital assets", "crypto taxes", "expat taxes"]
relatedGuideSlugs:
  - "crypto-taxes-expats"
relatedServiceSlugs:
  - "expat-tax-filing"
faqs:
  - question: "When are staking rewards taxable?"
    answer: "The timing and character depend on how the rewards were received and the applicable IRS guidance. Record receipt date, units, fair-market value, and platform statement."
  - question: "Does staking through a foreign exchange change the income?"
    answer: "It can create additional custody and foreign-account questions, but the income analysis still starts with the reward activity and records."
  - question: "What is the basis of staking rewards?"
    answer: "The tax basis and timing should be established under the applicable rules using the value and date of receipt. Keep a unit-level reconciliation."
---

# Staking Rewards and U.S. Tax for Expats

Staking rewards can arrive daily, weekly, or only when a protocol releases them. A U.S. person abroad needs a complete reward export and a fair-market-value method, not just a year-end token balance.

## Capture each reward event

Record token, units, date, wallet or platform, fair-market value, fees, and transaction ID. Separate rewards from later sales and swaps. If the platform is foreign, record its legal entity and custody terms for an FBAR and Form 8938 review.
...
This article is educational and does not determine reward timing or classification. FileAbroad can organize the records through the [tax filing intake](/intake?service=expat-tax-filing).
