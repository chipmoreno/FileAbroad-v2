...
import { getPersonaBySlug, getAllPersonaSlugs, getPersonaLongFormSections } from '@/lib/personas';
...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    ...
    alternates: { canonical: `https://fileabroad.com/personas/${slug}` },
    robots: { index: true, follow: true },
    openGraph: {
      title: persona.seo.title,
      description: persona.seo.description,
      url: `https://fileabroad.com/personas/${slug}`,
    },
  };
}
